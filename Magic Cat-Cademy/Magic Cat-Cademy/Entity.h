...
using ComponentTuple = std::tuple<CSprite, CAnimation, CState, CTransform, CBoundingBox, CInput, CGravity, CHealth, CMagic, CLifespan, CAttack, CImmunity, CBoss, CNPC>;
